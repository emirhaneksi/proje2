...
public class Meowth extends Pokemon {
    ...
    Image poke_Image=new Image("/prolab2/Icons/meow.jpg");

    public Image getPoke_Image() {
        return poke_Image;
    }
    ...
    public Meowth(String pokemonID, String pokemonAdi, String pokemonTip, Image PImage) {
